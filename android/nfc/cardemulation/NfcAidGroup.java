...
public final class NfcAidGroup extends AidGroup implements Parcelable {
  ...
  public static class ApduPatternGroup implements Parcelable {
    ...
    private boolean containsApduPattern(ApduPattern apduPattern) {
      ...
      for (ApduPattern apdu : apduList) {
        if (apdu.getreferenceData().equalsIgnoreCase(
                apduPattern.getreferenceData())) {
          status = true;
          break;
        }
      }
    ...
    public List<ApduPattern> getApduPattern() { return apduList; }
  ...
  public class ApduPattern {
    ...
    public String getreferenceData() { return reference_data; }
