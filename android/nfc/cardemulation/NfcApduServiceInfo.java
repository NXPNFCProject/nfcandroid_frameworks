...
public final class NfcApduServiceInfo
  ...
  public NfcApduServiceInfo(PackageManager pm, ResolveInfo info, boolean onHost)
    ...
    try {
      ...
      while (((eventType = parser.next()) != XmlPullParser.END_TAG ||
        ...
        if (!onHost && eventType == XmlPullParser.START_TAG &&
            "apdu-pattern-group".equals(tagName) &&
            currApduPatternGroup == null) {
          Log.e(TAG, "apdu-pattern-group");
          final TypedArray groupAttrs = res.obtainAttributes(
              attrs, com.android.internal.R.styleable.ApduPatternGroup);
          ...
          currApduPatternGroup =
              new NfcAidGroup.ApduPatternGroup(groupDescription);
          if (aidGroup != null) {
            /*
            ...
            try {
              group =
                  new AidGroup(CardEmulation.CATEGORY_OTHER, groupDescription);
              aidGroup = new NfcAidGroup(CardEmulation.CATEGORY_OTHER,
                                         groupDescription);
          ...
          groupAttrs.recycle();
        } else if (!onHost && eventType == XmlPullParser.END_TAG &&
                   "apdu-pattern-group".equals(tagName) &&
                   currApduPatternGroup != null) {
          ...
          Log.e(TAG, "apdu-pattern-group end");
        } else if (!onHost && eventType == XmlPullParser.START_TAG &&
                   "apdu-pattern-filter".equals(tagName) &&
                   currApduPatternGroup != null) {
          Log.e(TAG, "apdu pattern enter");
          TypedArray a = res.obtainAttributes(
              attrs, com.android.internal.R.styleable.ApduPatternFilter);
          String description =
              a.getString(com.android.internal.R.styleable
                              .ApduPatternFilter_description); //.toUpperCase();
          // String reference_data =
          // a.getString(com.android.internal.R.styleable.ApduPatternFilter_referenceData);
          // //.toUpperCase();
          String reference_data = a.getString(
              com.android.internal.R.styleable
                  .ApduPatternFilter_referenceData); //.toUpperCase();
          String mask =
              a.getString(com.android.internal.R.styleable
                              .ApduPatternFilter_apduMask); //.toUpperCase();
          Log.e(TAG,
                "valid apdu pattern" + reference_data + mask + description);
          Log.e(TAG, "valid apdu pattern reference_data" +
                         com.android.internal.R.styleable
                             .ApduPatternFilter_referenceData);
          Log.e(
              TAG,
              "valid apdu pattern reference_mask" +
                  com.android.internal.R.styleable.ApduPatternFilter_apduMask);
          Log.e(TAG, "valid apdu pattern description" +
                         com.android.internal.R.styleable
                             .ApduPatternFilter_description);
          if (isValidApduString(reference_data) && isValidApduString(mask)) {
            NfcAidGroup.ApduPattern apdu =
                mStaticNfcAidGroups.get(CardEmulation.CATEGORY_OTHER)
                    .new ApduPattern(reference_data, mask, description);
  ...
  public static boolean isValidApduString(String apdu) {
    ...
    if (apdu.length() < 2 || apdu.length() > 248 ||
        ((apdu.length() % 2) != 0)) {
