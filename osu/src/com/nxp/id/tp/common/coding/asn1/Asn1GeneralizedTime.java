 ...
 */
public final class Asn1GeneralizedTime extends Asn1Date {

  /** GENERALIZED TIME tag value, 0x18. */
  static final int TAG_INT = 0x18;

  /** GENERALIZED TIME tag value, 0x18. */
  public static final HexString TAG = HexString.fromInteger(TAG_INT);

  /** Date format used for ASN.1 GeneralizedTime. */
  private static final String DATE_FMT = "yyyyMMddHHmmss'Z'";

  /** Decoded date. */
  private Date date;

  /**
   * Parses a given GeneralizedTime string.
   *
   * @param genTime The TLV to parse
   *
   * @return An {@link Asn1GeneralizedTime} instance
   *
   * @throws InvalidAsn1CodingException On invalid input
   */
  public static Asn1GeneralizedTime parse(final HexString genTime)
      throws InvalidAsn1CodingException {

    return new Asn1GeneralizedTime(unwrap(TAG, genTime)[0]);
  }
   ...
   */
  public Asn1GeneralizedTime(final HexString dateTime)
      throws InvalidAsn1CodingException {
    super(TAG, dateTime);
   ...
   */
  public Asn1GeneralizedTime(final Date dateTime) {
   ...
   */
  public Asn1GeneralizedTime(final Date dateTime, final Locale locale) {
  ...
  public String toString(final int indent) {
    ...
    sb.append(spacer)
        .append("GENERALIZED TIME (len=" + getValue().length() + ") [")
  ...
  @Override
  public Asn1GeneralizedTime clone() {
